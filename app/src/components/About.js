...
const About = () => (
  <div className="container">
    <h2 className="heading">
      Does <span className="word">participation in SNAP</span> have an effect on{" "}
      <span className="word">chronic health conditions</span> and their
      outcomes?
    </h2>
    <p className="paragraph">
      The Supplemental Nutrition Assistance Program (SNAP) provides food
      benefits to low-income families to supplement their grocery budget so they
      can afford the nutritious food essential to health and well-being. In this
      project, we analyzed data from the Census Survey and the Center for
      Disease Control’s Behavorial Risk Factor Surveillance System (BRFSS) to
      see if there existed any significant improvements in health conditions
      among those who participate in SNAP.
    </p>
    ...
    <div>
      <Accordion className="accordion">
        ...
        <AccordionDetails className="details">
          ...
          improvements in health conditions among those who participate in SNAP.
        </AccordionDetails>
      </Accordion>
      <Accordion className="accordion">
        <AccordionSummary
        ...
        <AccordionDetails className="details">
          <i>
            <b>
              Between 2013 and 2022, increased SNAP allocation in each state
              will decrease the prevalence of Cardiovascular Disease, Diabetes,
